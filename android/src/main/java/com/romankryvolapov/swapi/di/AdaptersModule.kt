/**
 * factory<Class>(named("name")){Class()} -> for creating a specific instance in module
 * factory<Class1>{Class1(get<Class2>(named("name")))} -> for creating a specific instance in module
 ...
 * factory<Class>{(param: String)->Class(param)} -> parameter passing in module
...
val adaptersModule = module {
    ...
    singleOf(::PersonsAdapter)
    singleOf(::PlanetAdapter)
